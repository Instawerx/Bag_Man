...
#include "Effects/GE_AFL_Cooldown_Shield.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_Shield)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_Shield, "Cooldown.Weapon.Shield");


UGE_AFL_Cooldown_Shield::UGE_AFL_Cooldown_Shield()
{
	...
	// Grant Cooldown.Weapon.Shield for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_Shield);
