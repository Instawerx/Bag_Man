...
#include "Effects/GE_AFL_Cooldown_EMP.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_EMP)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_EMP, "Cooldown.Weapon.EMP");


UGE_AFL_Cooldown_EMP::UGE_AFL_Cooldown_EMP()
{
	...
	// Grant Cooldown.Weapon.EMP for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_EMP);
