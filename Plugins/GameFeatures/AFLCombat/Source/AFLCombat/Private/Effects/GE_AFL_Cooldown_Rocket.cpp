...
#include "Effects/GE_AFL_Cooldown_Rocket.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_Rocket)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_Rocket, "Cooldown.Weapon.Rocket");


UGE_AFL_Cooldown_Rocket::UGE_AFL_Cooldown_Rocket()
{
	...
	// Grant Cooldown.Weapon.Rocket for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_Rocket);
