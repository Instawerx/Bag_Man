...
#include "Effects/GE_AFL_Cooldown_SMG.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_SMG)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_SMG, "Cooldown.Weapon.SMG");


UGE_AFL_Cooldown_SMG::UGE_AFL_Cooldown_SMG()
{
	...
	// Grant Cooldown.Weapon.SMG for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_SMG);
