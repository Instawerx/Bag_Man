...
#include "Effects/GE_AFL_Cooldown_LobberArcLob.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_LobberArcLob)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_LobberArcLob, "Cooldown.Weapon.LobberArcLob");


UGE_AFL_Cooldown_LobberArcLob::UGE_AFL_Cooldown_LobberArcLob()
{
	...
	// Grant Cooldown.Weapon.LobberArcLob for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_LobberArcLob);
