...
#include "Effects/GE_AFL_Cooldown_Flak.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_Flak)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_Flak, "Cooldown.Weapon.Flak");


UGE_AFL_Cooldown_Flak::UGE_AFL_Cooldown_Flak()
{
	...
	// Grant Cooldown.Weapon.Flak for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_Flak);
