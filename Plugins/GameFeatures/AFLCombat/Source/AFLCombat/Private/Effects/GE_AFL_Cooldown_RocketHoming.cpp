...
#include "Effects/GE_AFL_Cooldown_RocketHoming.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_RocketHoming)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_RocketHoming, "Cooldown.Weapon.RocketHoming");


UGE_AFL_Cooldown_RocketHoming::UGE_AFL_Cooldown_RocketHoming()
{
	...
	// Grant Cooldown.Weapon.RocketHoming for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_RocketHoming);
