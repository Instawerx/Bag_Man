...
#include "Effects/GE_AFL_Cooldown_Railgun.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_Railgun)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_Railgun, "Cooldown.Weapon.Railgun");


UGE_AFL_Cooldown_Railgun::UGE_AFL_Cooldown_Railgun()
{
	...
	// Grant Cooldown.Weapon.Railgun for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_Railgun);
