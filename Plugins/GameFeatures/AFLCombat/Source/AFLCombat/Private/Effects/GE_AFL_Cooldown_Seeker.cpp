...
#include "Effects/GE_AFL_Cooldown_Seeker.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_Seeker)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_Seeker, "Cooldown.Weapon.Seeker");


UGE_AFL_Cooldown_Seeker::UGE_AFL_Cooldown_Seeker()
{
	...
	// Grant Cooldown.Weapon.Seeker for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_Seeker);
