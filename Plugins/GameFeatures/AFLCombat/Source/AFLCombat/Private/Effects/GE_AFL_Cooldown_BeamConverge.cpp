...
#include "Effects/GE_AFL_Cooldown_BeamConverge.h"

#include "GameplayEffectComponents/TargetTagsGameplayEffectComponent.h"
#include "NativeGameplayTags.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GE_AFL_Cooldown_BeamConverge)
...
UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Cooldown_Weapon_BeamConverge, "Cooldown.Weapon.BeamConverge");


UGE_AFL_Cooldown_BeamConverge::UGE_AFL_Cooldown_BeamConverge()
{
	...
	// Grant Cooldown.Weapon.BeamConverge for the duration. CreateDefaultSubobject (templated AddComponent<> can't
	...
	Granted.Added.AddTag(TAG_Cooldown_Weapon_BeamConverge);
