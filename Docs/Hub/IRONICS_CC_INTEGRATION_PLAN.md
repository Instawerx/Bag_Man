...
| **I-25+** | The ratified Claude Design mock + spec (`Docs/Hub/Design/IRONICS_CC_DESIGN_SPEC.md`): grid, gutters, A–F proportions, kit states, bind map. Appended here when the operator ratifies | `IRONICS_CC_DESIGN_BRIEF.md` §7 |
