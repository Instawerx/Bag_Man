...
- Snapshot: **272 registered SKUs** (2026-07-03) = 122 baseline + 3 factory weapons x 50 (base + 48-color grid + GlitchLegend). **All 3 pilot axes PIE-PROVEN** + the **48-color system BUILT** (49 MIs off the locked master; 6 families x 6 SPARK + 12 SURGE legendary). Full palette: `IRONICS_CATALOG_MATRIX.md`.
...
| WEAPON | 152 | DIRECT | `AFL.Weapon.<Base>.<Color>` -- Pistol, ShotgunBeam (2) + Arclight/Voltaic/Ioncaster x 50 each (base + 48-color grid + GlitchLegend, 2026-07-03) |
